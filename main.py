...
parser.add_argument('--x', type=float, nargs=1, help='Insert x value for when the formula does not use coordinates.')
parser.add_argument('--y', type=float, nargs=1, help='Insert y value for when the formula does not use coordinates.')
